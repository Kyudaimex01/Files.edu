...
(function(t) {
    ...
    function i(e) {
        function n(n, s) {
            t.isPlainObject(s) && t.isPlainObject(e[n]) && !r(n)
                ? (e[n] = i({}, e[n], s))
                : void 0 !== s && (e[n] = s);
        }
        ...
        c(e),
            e.each(function(n, i) {
                var d = n === e.length - 1 ? s : r,
                    c = t(i).outerHeight(!0);
                d > c
                    ? (o.push(i), l.push(c), a.push(t(i).height()))
                    : (u += c);
            }),
            i &&
                ((n -= u),
    ...
    function b(t, e) {
        ...
        for (
            n = 0;
            ze.length > n && ((i = ze[n]), (r = D(i, t, e)), !(r >= 1 && V(r)));
            n++
        );
        return i;
    }
    ...
    function W(t, e) {
        ...
        return "string" == typeof e
            ...
            ? Ae[n]
                ? Ae[n](t)
                : B(t, n)
            : e.maybe && ((i = I(t, e.maybe)), i.match(/[1-9]/))
            ? i
            : "";
    }
    ...
    function X(t, e, n, i, r) {
        var s,
            ...
            h = "",
            f = "";
        for (o = 0; n.length > o && ((s = $(t, e, n[o])), s !== !1); o++)
            u += s;
        for (l = n.length - 1; l > o && ((s = $(t, e, n[l])), s !== !1); l--)
            d = s + d;
    ...
    function $(t, e, n) {
        ...
        return "string" == typeof n
            ? n
            : (i = n.token) && ((r = Ne[i.charAt(0)]), r && t.isSame(e, r))
            ? B(t, i)
            : !1;
    }
    function U(t) {
    ...
    function ce(t) {
        ...
        if (void 0 === t.forwardPressure) {
            for (e = 0; i.length > e; e++)
                (n = i[e]), ce(n), (r = Math.max(r, 1 + n.forwardPressure));
            t.forwardPressure = r;
        }
    }
    function he(t, e, n) {
    ...
    function me(n, r) {
        ...
        function a() {
            (re = Q.theme ? "ui" : "fc"),
                n.addClass("fc"),
                Q.isRTL ? n.addClass("fc-rtl") : n.addClass("fc-ltr"),
                Q.theme ? n.addClass("ui-widget") : n.addClass("fc-unthemed"),
                (ie = t("<div class='fc-view-container'/>").prependTo(n)),
                (ee = new ve(q, Q)),
                (ne = ee.render()),
                ne && n.prepend(ne),
                c(Q.defaultView),
                Q.handleWindowResize &&
                    ((le = G(w, Q.windowResizeDelay)), t(window).resize(le));
        }
        function u() {
            se && se.destroyView(),
                ee.destroy(),
        ...
        function c(e) {
            fe++,
                se &&
                    e &&
                    se.type !== e &&
                    (ee.deactivateButton(se.type),
                    I(),
                    se.start && se.destroyView(),
                    se.el.remove(),
                    (se = null)),
                !se &&
                    e &&
                    ...
                    ee.activateButton(e)),
                se &&
                    ((ae = se.massageCurrentDate(ae)),
                    (se.start &&
                        ae.isWithin(se.intervalStart, se.intervalEnd)) ||
                        (d() &&
                            (I(),
                            se.start && se.destroyView(),
                            se.setDate(ae),
        ...
        function f(n) {
            ...
            if (he[n]) return he[n];
            for (; f && !s; )
                (r = {}), i(Ce[f]), i(h[f]), g.unshift(r), (f = r.type);
            return (
                g.unshift({}),
                (r = t.extend.apply(t, g)),
                s
                    ? ((l = r.duration || s.duration),
                      l &&
                          ((l = e.duration(l)),
                          (a = b(l)),
                          (p = 1 === l.as(a))),
                      p && h[a] && (r = t.extend({}, h[a], r)),
                      (u =
                          c[n] ||
                          (p ? c[a] : null) ||
                          d[n] ||
                          ...
                          (l ? o(l) : null) ||
                          n),
                      (he[n] = { class: s, options: r, buttonText: u }))
                    : void 0
            );
        }
        function g(t) {
        ...
        function y() {
            oe =
                "number" == typeof Q.contentHeight
                    ? Q.contentHeight
                    : "number" == typeof Q.height
                    ? Q.height - (ne ? ne.outerHeight(!0) : 0)
                    : Math.round(ie.width() / Math.max(Q.aspectRatio, 0.5));
        }
        function w(t) {
            !fe &&
                t.target === window &&
        ...
        function M() {
            var t = q.getNow();
            t.isWithin(se.intervalStart, se.intervalEnd)
                ? ee.disableButton("today")
                : ee.enableButton("today");
        }
        function F(t, e) {
            (t = q.moment(t)),
                (e = e
        ...
        function B(t, e) {
            ...
            (e && g(e)) ||
                ((e = e || "day"),
                (n = ee.getViewsWithButtons().join(" ")),
                (i = n.match(RegExp("\\w+" + L(e)))),
                i || (i = n.match(/\w+Day/)),
                (e = i ? i[0] : "agendaDay")),
                (ae = t),
                c(e);
        ...
        function U(t, e) {
            return Q[t]
                ? Q[t].apply(e || ce, Array.prototype.slice.call(arguments, 2))
                : void 0;
        }
        var q = this;
        r = r || {};
        var K,
            Q = i({}, Ee, r);
        (K = Q.lang in Te ? Te[Q.lang] : Te[Ee.lang]),
            K && (Q = i({}, Ee, K, r)),
            Q.isRTL && (Q = i({}, Ee, be, K || {}, r)),
            (q.options = Q),
            (q.render = l),
            (q.destroy = u),
            (q.refetchEvents = E),
            (q.reportEvents = H),
            (q.reportEventChange = R),
            (q.rerenderEvents = S),
            (q.changeView = c),
            (q.select = F),
            (q.unselect = z),
            ...
            (q.trigger = U),
            (q.isValidViewType = g),
            (q.getViewButtonText = p);
        var J = x(s(Q.lang));
        if (
            (Q.monthNames && (J._months = Q.monthNames),
            Q.monthNamesShort && (J._monthsShort = Q.monthNamesShort),
            Q.dayNames && (J._weekdays = Q.dayNames),
            Q.dayNamesShort && (J._weekdaysShort = Q.dayNamesShort),
            null != Q.firstDay)
        ) {
            var te = x(J._week);
            (te.dow = Q.firstDay), (J._week = te);
        }
        (q.defaultAllDayEventDuration = e.duration(
            Q.defaultAllDayEventDuration
        )),
            (q.defaultTimedEventDuration = e.duration(
                Q.defaultTimedEventDuration
            )),
            (q.moment = function() {
                var t;
                return (
                    "local" === Q.timezone
                        ? ((t = De.moment.apply(null, arguments)),
                          t.hasTime() && t.local())
                        : (t =
                              "UTC" === Q.timezone
                                  ? De.moment.utc.apply(null, arguments)
                                  : De.moment.parseZone.apply(null, arguments)),
                    "_locale" in t ? (t._locale = J) : (t._lang = J),
                    t
                );
            }),
            ...
            (q.getEventEnd = function(t) {
                return t.end
                    ? t.end.clone()
                    : q.getDefaultEventEnd(t.allDay, t.start);
            }),
        ...
        var ee,
            ...
            fe = 0,
            ge = [];
        (ae = null != Q.defaultDate ? q.moment(Q.defaultDate) : q.getNow()),
                            ...
                            "title" == r
                                ...
                                : (e[r]
                                      ...
                                      : e.isValidViewType(r) &&
                                        ...
                                        p.push(r),
                                        (c = e.getViewButtonText(r))),
                                  l &&
                                      ((a = w(n.themeButtonIcons, r)),
                                      (u = w(n.buttonIcons, r)),
                                      (d = w(n.defaultButtonText, r)),
                                      (h = w(n.buttonText, r)),
                                      (g =
                                          c || h
                                              ? z(c || h)
    ...
    function ye(n) {
        function i(t, e) {
            return (
                !B ||
                t.clone().stripZone() < B.clone().stripZone() ||
                e.clone().stripZone() > Z.clone().stripZone()
            );
        }
        function r(t, e) {
            (B = t), (Z = e), (Q = []);
        ...
        function o(e, i) {
            ...
            for (r = 0; l.length > r; r++) {
                if (
                    ((s = l[r].call(O, e, B.clone(), Z.clone(), n.timezone, i)),
                    s === !0)
                )
                    return;
            ...
            if (a)
                t.isFunction(a)
                    ? (y(),
                      a.call(O, B.clone(), Z.clone(), n.timezone, function(t) {
                          i(t), w();
                      }))
                    : t.isArray(a)
                    ? i(a)
        ...
        function p(t, e) {
            var n,
                ...
                s = b(t);
            if (s) {
                for (n = H(s), i = 0; n.length > i; i++)
                    (r = n[i]),
                        r.source ||
                            (e && (X.events.push(r), (r.source = X)),
                            Q.push(r));
                return j(Q), n;
            }
            return [];
        ...
        function b(i, r) {
            ...
            if (
                ...
                t.extend(a, i),
                r && (a.source = r),
                (a._id = i._id || (void 0 === i.id ? "_fc" + Qe++ : i.id + "")),
                ...
                o && ((o = O.moment(o)), o.isValid() || (o = null)),
                    (l = i.allDay),
                    void 0 === l &&
                        (l = F(r ? r.allDayDefault : void 0, n.allDayDefault)),
                    D(s, o, l, a);
            }
            return a;
        }
        ...
        function C(t) {
            null == t.allDay &&
                ...
                t.allDay
                    ...
                    : (t.start.hasTime() || (t.start = O.rezoneDate(t.start)),
                      t.end &&
                          !t.end.hasTime() &&
                          (t.end = O.rezoneDate(t.end))),
                t.end && !t.end.isAfter(t.start) && (t.end = null),
                t.end ||
                    (t.end = n.forceEventDuration
                        ? O.getDefaultEventEnd(t.allDay, t.start)
                        : null);
        }
        function x(t) {
            var e;
        ...
        function R(e, n) {
            ...
            return (
                ...
                !i &&
                    n.end &&
                    (s = E(n.end, n.start).subtract(
                        E(
                            e._end || O.getDefaultEventEnd(e._allDay, e._start),
                            e._start
                        )
                    )),
        ...
        function G(t, e, n, i) {
            ...
            for (o = 0; Q.length > o; o++)
                if (((l = Q[o]), (!i || i._id !== l._id) && Y(l, t))) {
                    ...
                    if (i) {
                        if (
                            ((a = F(l.overlap, (l.source || {}).overlap)),
                            a === !1)
                        )
                            return !1;
        ...
        t.each(
            ...
            (O.getBusinessHoursEvents = _),
            (O.isEventRangeAllowed = L),
            (O.isSelectionRangeAllowed = P),
            (O.isExternalDropRangeAllowed = V);
    }
    function we(t) {
        (t._allDay = t.allDay),
    ...
    var Ee = {
        ...
        De = (t.fullCalendar = { version: "2.2.7" }),
        Ce = (De.views = {});
    ...
    (De.moment = function() {
        ...
        (Ve.format = function() {
            return this._fullCalendar && arguments[0]
                ...
                ? B(this, "YYYY-MM-DD")
                : this._ambigZone
                ? B(this, "YYYY-MM-DD[T]HH:mm:ss")
                : Ge.format.apply(this, arguments);
        }),
        (Ve.toISOString = function() {
            return this._ambigTime
                ...
                : this._ambigZone
                ? B(this, "YYYY-MM-DD[T]HH:mm:ss")
                : Ge.toISOString.apply(this, arguments);
        }),
    ...
    var Oe = K.extend({
            ...
            render: function() {
                ...
                (this.el = t('<div class="fc-popover"/>')
                    ...
                    n.autoHide &&
                        t(document).on(
                            "mousedown",
                            (this.documentMousedownProxy = t.proxy(
                                this,
                                "documentMousedown"
                            ))
                        );
                ...
                (r = o.top || 0),
                    (s =
                        void 0 !== o.left
                            ...
                            ? o.right - a
                            : 0),
                    c.is(window) || c.is(document)
                        ? ((c = d), (e = 0), (n = 0))
                        : ((i = c.offset()), (e = i.top), (n = i.left)),
                    (e += d.scrollTop()),
                    (n += d.scrollLeft()),
                    o.viewportConstrain !== !1 &&
                        ((r = Math.min(
                            r,
                            e + c.outerHeight() - u - this.margin
                        )),
                        (r = Math.max(r, e + this.margin)),
                        (s = Math.min(s, n + c.outerWidth() - a - this.margin)),
        ...
        Ie = K.extend({
            ...
            startListening: function(e) {
                ...
                this.isListening ||
                    ...
                    t(document)
                        ...
                        .on(
                            "mouseup",
                            (this.mouseupProxy = t.proxy(this, "mouseup"))
                        )
            ...
            cellOut: function() {
                this.cell &&
                    (this.trigger("cellOut", this.cell), (this.cell = null));
            },
            mouseup: function(t) {
        ...
        Xe = (De.Grid = je.extend({
            ...
            constructor: function() {
                je.apply(this, arguments),
                    ...
                    (this.elsByFill = {}),
                    (this.documentDragStartProxy = t.proxy(
                        this,
                        "documentDragStart"
                    ));
            },
                    ...
                    o = new Ie(this.coordMap, {
                        ...
                        cellOver: function(t, r) {
                            ...
                            l &&
                                ((e = r ? t : null),
                                s &&
                                    ((n = i.computeSelection(l, t)),
                                    n ? i.renderSelection(n) : a()));
                        },
                        cellOut: function() {
    ...
    Xe.mixin({
        ...
        renderEvents: function(t) {
            var e,
                ...
                s = [];
            for (e = 0; i.length > e; e++)
                (n = i[e]), J(n.event) ? r.push(n) : s.push(n);
            ...
            t.each(
                {
                    ...
                    mousedown: function(i, r) {
                        ...
                        n.isEventResizable(i.event)
                            ? e.segResizeMousedown(i, r)
                            : n.isEventDraggable(i.event) &&
                ...
                d = new Ie(r.coordMap, {
                    ...
                    cellOver: function(e, s) {
                        ...
                        (n = i.computeEventDrop(u, e, o)),
                            n
                                ? (r.renderDrag(n, t) ? l.hide() : l.show(),
                                  s && (n = null))
                                : (l.show(), a());
                    },
                    cellOut: function() {
            ...
            return (
                a.hasTime() === u.hasTime()
                    ? ((i = E(u, a)),
                      ...
                      (o = n.allDay))
                    : ((r = u.clone()), (s = null), (o = !u.hasTime())),
                (l = { start: r, end: s, allDay: o }),
            ...
            (r = new Ie(this.coordMap, {
                ...
                cellOver: function(e) {
                    (i = e.end),
                        ...
                        i.isSame(f)
                            ? (i = null)
                            : l.isEventRangeAllowed({ start: h, end: i }, c)
                            ? (s.renderEventResize({ start: h, end: i }, t),
                              o.hideEvent(c))
                            : ((i = null), a());
                },
                cellOut: function() {
        ...
        eventsToInverseRanges: function(t) {
            var e,
                ...
                a = t[0],
                u = r;
            for (o.sort(ie), e = 0; o.length > e; e++)
                (n = o[e]),
        ...
        eventRangeToSegs: function(t, e) {
            var n, i, r;
            for (n = e ? e(t) : this.rangeToSegs(t), i = 0; n.length > i; i++)
                (r = n[i]),
                    (r.event = t.event),
            ...
            for (
                ...
                (r = i * f),
                    ...
                    u >= a &&
                        ...
                        (a -= r),
                        (u -= r),
                        (d = { row: i, isStart: o, isEnd: l }),
                        c
                            ? ((d.leftCol = f - u - 1),
                              (d.rightCol = f - a - 1))
                            : ((d.leftCol = a), (d.rightCol = u)),
                        g.push(d));
            return g;
        },
        ...
        renderDrag: function(t, e) {
            ...
            return (
                this.renderHighlight(
                    this.view.calendar.ensureVisibleEventRange(t)
                ),
                e && !e.el.closest(this.el).length
            ...
            (s = this.renderFgSegEls(s)),
                ...
                this.rowEls.each(function(e, s) {
                    ...
                    (o =
                        n && n.row === e
                            ? n.el.position().top
                            : l.find(".fc-content-skeleton tbody").position()
                                  .top),
                        a
                            .css("top", o)
                            .find("table")
    ...
    $e.mixin({
        ...
        getEventSegs: function() {
            return Xe.prototype.getEventSegs
                .call(this)
        ...
        fgSegHtml: function(t, e) {
            var n,
                ...
                u = "";
            return (
                l.unshift("fc-day-grid-event"),
                !r.allDay &&
                    t.isStart &&
                    (u =
                        '<span class="fc-time">' +
                        z(this.getEventTimeText(r)) +
                        "</span>"),
                (n =
                    '<span class="fc-title">' +
                    (z(r.title || "") || "&nbsp;") +
        ...
        $e.mixin({
                ...
                return t('<a class="fc-more"/>')
                    ...
                    .on("click", function(s) {
                        ...
                        "function" == typeof o &&
                            ...
                            "popover" === o
                                ? i.showSegPopover(e, a, c)
                                : "string" == typeof o &&
                                  r.calendar.zoomTo(l, o);
                    });
            },
            ...
            getCellSegs: function(t, e) {
                for (
                    var n,
                        i = this.rowStructs[t.row].segMatrix,
                        r = e || 0,
                        s = [];
                    i.length > r;
    ...
    var Ue = Xe.extend({
        ...
        slatRowHtml: function() {
            for (
                var t,
                    ...
                    s = this.isRTL,
                    o = "",
                    l = 0 === this.slotDuration.asMinutes() % 15,
        ...
        computeRowCoords: function() {
            ...
            return (
                (e.bottom =
                    e.top + this.computeTimeTop(this.computeSnapTime(t))),
                i
            );
        },
            ...
            if (n.length) {
                for (
                    ...
                    if (((a = r[l]), (u = t("<td/>").appendTo(o)), a.length))
                        for (
                            d = t(
                                '<div class="fc-' + i + '-container"/>'
                            ).appendTo(u),
                                c = this.colData[l].day,
                                h = 0;
                            a.length > h;
                            h++
                        )
            ...
            return (
                ...
                '<a class="' +
                    ...
                    (n
                        ...
                        : "") +
                    (o.title
                        ? '<div class="fc-title">' + z(o.title) + "</div>"
                        : "") +
                    "</div>" +
                    '<div class="fc-bg"/>' +
            ...
            return (
                ...
                void 0 !== n
                    ...
                    : ((n = this.calendar.options[e]),
                      t.isPlainObject(n) && !r(e) ? w(n, this.type) : n)
            );
        },
        ...
        computeRange: function(t) {
            ...
            return (
                /year|month|week|day/.test(s)
                    ? (o.stripTime(), l.stripTime())
                    : (o.hasTime() || (o = this.calendar.rezoneDate(o)),
                      l.hasTime() || (l = this.calendar.rezoneDate(l))),
                (n = o.clone()),
        ...
        massageCurrentDate: function(t, n) {
            return (
                this.intervalDuration <= e.duration({ days: 1 }) &&
                    this.isHiddenDay(t) &&
                    ((t = this.skipHiddenDays(t, n)), t.startOf("day")),
                t
            );
        },
        ...
        Je = (Ce.basic = qe.extend({
            ...
            numberIntroHtml: function(t) {
                return this.weekNumbersVisible
                    ? '<td class="fc-week-number" ' +
                          ...
                          ">" +
                          "<span>" +
                          this.calendar.calculateWeekNumber(
                              this.dayGrid.getCell(t, 0).start
                          ) +
                          "</span>" +
                          "</td>"
                    : void 0;
            ...
            numberCellHtml: function(t) {
                ...
                return this.dayNumbersVisible
                    ? ((e = this.dayGrid.getDayClasses(n)),
                      e.unshift("fc-day-number"),
                      '<td class="' +
                          e.join(" ") +
                          '" data-date="' +
                          n.format() +
            ...
            updateWidth: function() {
                this.weekNumbersVisible &&
                    (this.weekNumberWidth = h(this.el.find(".fc-week-number")));
            },
            setHeight: function(t, e) {
                ...
                g(this.scrollerEl),
                    ...
                    !e &&
                        f(this.scrollerEl, n) &&
                        (o(this.headRowEl, m(this.scrollerEl)),
                        (n = this.computeScrollerHeight(t)),
    ...
    var tn = (Ce.month = Je.extend({
        computeRange: function(t) {
            var e,
                n = Je.prototype.computeRange.call(this, t);
            return (
                this.isFixedWeeks() &&
    ...
    (tn.duration = { months: 1 }),
        (Ce.basicWeek = { type: "basic", duration: { weeks: 1 } }),
        (Ce.basicDay = { type: "basic", duration: { days: 1 } }),
        n({
            allDaySlot: !0,
            allDayText: "all-day",
            scrollTime: "06:00:00",
    ...
    (Ce.agenda = qe.extend({
        ...
        dayIntroHtml: function() {
            return (
                ...
                ">" +
                "<span>" +
                (this.opt("allDayHtml") || z(this.opt("allDayText"))) +
                "</span>" +
                "</td>"
            );
        },
        ...
        setHeight: function(t, e) {
            ...
            null === this.bottomRuleHeight &&
                ...
                this.dayGrid &&
                    ...
                    n && "number" != typeof n && (n = en),
                    n && this.dayGrid.limitRows(n)),
                e ||
                    ((i = this.computeScrollerHeight(t)),
                    f(this.scrollerEl, i)
                        ? (o(this.noScrollRowEls, m(this.scrollerEl)),
                          (i = this.computeScrollerHeight(t)),
        ...
        (Ce.agendaWeek = { type: "agenda", duration: { weeks: 1 } }),
        (Ce.agendaDay = { type: "agenda", duration: { days: 1 } });
});
