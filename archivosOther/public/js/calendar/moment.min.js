...
(function(a) {
        ...
        for (e = Q(b._f, b._locale).match(Pb) || [], c = 0; c < e.length; c++)
            (f = e[c]),
                ...
                d &&
                    ...
                    (j += d.length)),
                rc[f]
                    ? (d ? (b._pf.empty = !1) : b._pf.unusedTokens.push(f),
                      T(f, d, b))
    ...
    function bb(a) {
        ab(a),
            a._isValid === !1 &&
                (delete a._isValid, vb.createFromInputFallback(a));
    }
    function cb(a, b) {
        var c,
            d = [];
    ...
    (rc.DDDD = h(rc.DDD, 3)),
        o(l.prototype, {
            ...
            _months: "Enero_Febrero_Marzo_Abril_Mayo_Junio_Julio_Agosto_Septiembre_Octubre_Noviembre_Diciembre".split(
                "_"
            ),
            months: function(a) {
                return this._months[a.month()];
            },
            _monthsShort: "Ene_Feb_Mar_Abr_May_Jun_Jul_Ago_Sep_Oct_Nov_Dic".split(
                "_"
            ),
            ...
            _weekdays: "Domingo_Lunes_Martes_Miercoles_Jueves_Viernes_Sabado".split(
                "_"
            ),
            weekdays: function(a) {
    ...
    (vb.normalizeUnits = function(a) {
        ...
        o((vb.fn = m.prototype), {
                ...
                return (
                    this._tzm
                        ...
                        : "string" == typeof this._i &&
                          this.utcOffset(S(this._i)),
                    this
                );
            },
            hasAlignedHourOffset: function(a) {
                return (
                    (a = a ? vb(a).utcOffset() : 0),
            ...
            dayOfYear: function(a) {
                var b =
                    Ab(
                        (vb(this).startOf("day") - vb(this).startOf("year")) /
                            864e5
                    ) + 1;
        ...
        o((vb.duration.fn = n.prototype), {
            ...
            abs: function() {
                return (
                    ...
                    (this._data.milliseconds = Math.abs(
            ...
            as: function(a) {
                ...
                switch (
                    ((b = this._days + Math.round(sb(this._months / 12))), a)
                ) {
                    case "week":
