...
@section('navbar')
    <link href="{{ asset('css/cs/collapsible.css') }}" rel="stylesheet" media="all">
    <script src="{{ asset('css/cs/collapsible.js') }}" type="text/javascript"></script>
                                        ...
                                        <div class="modal-body">
                                            <form method="POST" action="{{ route('login') }}" aria-label="{{ __('Login') }}">
                                                ...
                                                <div class="form-group row">
                                                    <label for="email" class="col-sm-4 col-form-label text-md-right" style="color: #002a80">{{ __('E-Mail Address') }}</label>
                                                ...
                                                <div class="form-group row">
                                                    <label for="password" class="col-md-4 col-form-label text-md-right" style="color: #002a80">{{ __('Password') }}</label>
    ...
    <nav class="nav-primary" aria-label="Main" itemscope="">
        <div class="wrap">
            <ul id="menu-menucomercial" class="menu genesis-nav-menu menu-primary">
                <li id="menu-item-8121" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-8121">
                    <form class="form-header" action="">
                        <input id="text" style="width: 200px" class="au-input--full" type="text" name="search" placeholder="Search..." />
                        <a class="au-btn--submit" style="height: 43px;" type="button" onclick="showSearchBox()">
                            <i class="zmdi zmdi-search"></i>
                        </a>
                    </form>
                    <style>
                        .myhidden{ width: 300px;}
                    </style>
                </li>
                @if(auth::guest())
                    <li id="menu-item-8122"
