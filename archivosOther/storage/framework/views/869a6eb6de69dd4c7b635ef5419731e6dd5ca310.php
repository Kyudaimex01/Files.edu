...
<!--1-->
    ...
    <link rel="stylesheet" id="altitude-pro-theme-css"
          href="<?php echo e(asset('css/style.css')); ?>" type="text/css" media="all">
    <style id="altitude-pro-theme-inline-css" type="text/css">
        .front-page-1 {
            background-image: url(<?php echo e(asset('/img/Archivo_libros_1024x768.png')); ?> );
        }
...
<!-- 2 -->
    ...
    <style type="text/css">.site-title a {
            background: url(<?php echo e(asset('img/logo-archivos-web.png')); ?>) no-repeat !important;
        }</style>
<!-- 3 -->
...
<!--    <link href="<?php echo e(asset('css/stylehead.css')); ?>" rel="stylesheet">-->
    <link href="<?php echo e(asset('css/styleheadaux.css')); ?>" rel="stylesheet" id="wp-custom-css">
<!--<script src="<?php echo e(asset('js/jquery.jscroll.min.js')); ?>"></script> -->
    <link href="<?php echo e(asset('css/search-form.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('css/user.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('css/front.min.css')); ?>" rel="stylesheet">
